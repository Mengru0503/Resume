...
const projects = [
  ...
  },
  {
    ...
    description: {
      en: "A shoe brand e-commerce website featuring product listing pages and responsive layout design, showcasing modern frontend UI structure and interaction.",
      zh: "鞋類品牌電商網站，包含商品列表頁與響應式版面設計，呈現現代前端 UI 結構與互動體驗。"
    },
